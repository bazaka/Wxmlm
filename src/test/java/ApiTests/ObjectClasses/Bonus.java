...
public class Bonus {
    ...
    public Bonus(int bId, int bUserId, int bPartnerId, int bOperationId, int bPurchaseId, int bType, int bPercent, String bCreatedDate, String bUpdatedDate ){
        this.setId(bId);
        this.setUserId(bUserId);
        this.setPartnerId(bPartnerId);
        this.setOperationId(bOperationId);
        this.setPurchaseId(bPurchaseId);
        this.setType(bType);
    ...
    public boolean equalsExceptUpdatedDate(Bonus a, boolean toCheckCreateDate){
        if(this == a)
            return true;
        if(a == null){
        ...
        if(toCheckCreateDate && !getCreatedDate().equals(a.getCreatedDate())){
