...
public class PutOperationsUpdate {
    public boolean testPutOperationsUpdate(String siteUrl, TestUser user) throws IOException {
        long startTime;
        long elapsedTime;
        Operation originalOperation = new GetOperations(user).getAnyOperation(user, siteUrl);
        ...
        Operation changedOperation = new GetOperations(user).getOperationByParameter("id", originalOperation.getId(), user, siteUrl);
        ...
        changedOperation = new GetOperations(user).getOperationByParameter("id", originalOperation.getId(), user, siteUrl);
