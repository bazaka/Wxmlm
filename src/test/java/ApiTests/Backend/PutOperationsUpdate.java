...
public class PutOperationsUpdate {
    public boolean testPutOperationsUpdate(String siteUrl, TestUser user) throws IOException {
        long startTime;
        long elapsedTime;
        Operation originalOperation = new GetOperations().getAnyOperation(user, siteUrl);
        ...
        Operation changedOperation = new GetOperations().getOperationByParameter("id", originalOperation.getId(), user, siteUrl);
        ...
        changedOperation = new GetOperations().getOperationByParameter("id", originalOperation.getId(), user, siteUrl);
