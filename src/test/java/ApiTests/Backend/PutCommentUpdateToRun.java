...
public class PutCommentUpdateToRun {
    ...
    public void testPutCommentUpdate() throws IOException {
        ...
        assertTrue("Check modified data saved correctly", modifiedOne.equalsExceptDates(changedOne, true, true));
        ...
        assertTrue("Check modified data returned correctly", originalOne.equalsExceptDates(changedOne, true, true));
